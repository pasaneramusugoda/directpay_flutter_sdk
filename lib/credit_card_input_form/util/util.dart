...
final master = Image.asset('packages/flutter_mpgs_sdk/assets/images/mastercard.png',
    width: 50);
final visa = Image.asset('packages/flutter_mpgs_sdk/assets/images/visacard.png',
    width: 50);
final discover = Image.asset('packages/flutter_mpgs_sdk/assets/images/discover.png',
    width: 50);

final amex = Image.asset('packages/flutter_mpgs_sdk/assets/images/amex.png',
    width: 50);
